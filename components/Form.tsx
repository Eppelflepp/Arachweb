...
const Form: React.FC<FormProps> = ({ placeholder, isComment, postId }) => {
  ...
  const { mutate: mutatePosts } = usePosts(currentUser?.id); // Pass currentUser?.id as the userId argument if available
  ...
  // If user is not logged in, show the login/register options
  ...
  // If user is logged in, show the tweet form
  return (
